'''
    Analyze the coverage of MeSH terms from KNN papers in different settings. 
...
class Earlier_pmids_as_ref(object):
    ...
    def index_alternative(self):
        ...
        print "MeSH ready"
        if not os.path.exists(os.path.join(self.index_dir, self.medline_1997_index_file)):
...
if __name__=="__main__":
    ...
    # recent_pmids.run()
    ## evalute the coverage of NLM2007 pmids in earlier MEDLINE corpus
    nlm2007_pmids = Earlier_pmids_as_ref()
    nlm2007_pmids.run()
    #
