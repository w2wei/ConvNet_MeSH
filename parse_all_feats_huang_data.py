'''
  ...
  Data from Huang2011, SMALL200, NLM2007, L1000
...
if __name__ == '__main__':
    ...
    # data_dir = "/media/workspace/weiwei/knn_sample" # for gpu1
    ...
    dev_mti_file = os.path.join(dev_dir, "NLM2007_MTI.out")
    test_dir = os.path.join(raw_data_dir, "L1000")
    test_mti_file = os.path.join(test_dir, "L1000_MTI.out")
    ...
    outdir = os.path.join(data_dir, wkdir)
