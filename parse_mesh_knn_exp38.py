...
if __name__ == '__main__':
    ...
    raw_train = cdata.Data(data2_dir, outdir, wkdir, index_dir, time_span, sample_size, pmid_year_dict_file)
    raw_train.run()
    ...
    raw_dev = kdata.Data(lu_data_dir, clean_lu_data_dir)    
    raw_dev.nlm2007()
    print "raw dev ready"
