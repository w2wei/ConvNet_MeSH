...
def compute_overlap_features(questions, answers, word2df=None, stoplist=None):
  ...
  for question, answer in zip(questions, answers):
    ...
    feats_overlap.append(np.array([
                         ...
                         df_overlap, ## normalized idf of overlap tokens
                         ]))
...
if __name__ == '__main__':
  ...
  for train in train_files:
    ...
    qids, questions, answers, labels = load_data(all_fname) ## questions and answers are lists of lists, qids and labels are lists
    print "qids: ", len(qids)
    print qids[:2]
    print
    ...
    docs = answers + unique_questions ## a list of lists
