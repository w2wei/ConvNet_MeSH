...
def main():
    ...
    nnet_outdir = 'exp.out/Exp_46_2;ndim={};batch={};max_norm={};learning_rate={};{}'.format(ndim, batch_size, max_norm, learning_rate, ts)
    ...
    print "Exp_46_2 MAP on test set: ", test_acc/100.0
    print    
