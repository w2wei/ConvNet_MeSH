...
def main():
    ...
    nnet_outdir = 'exp.out/{};Exp_47_3;ndim={};batch={};max_norm={};learning_rate={};{}'.format(ndim, batch_size, max_norm, learning_rate, ts)
    ...
    print "Exp_47_3 MAP on test set: ", test_acc/100.0
    print    
