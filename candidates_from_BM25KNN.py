...
class BM25KNN_candidates(object):
    ...
    def get_BM25KNN_candidates(self):
...
if __name__=="__main__":
    ...
    L1000_top_cands = BM25KNN_candidates(data_dir, data2_dir, knn_base_dir, analysis_dir, time_span, pmid_year_dict_file)
    L1000_top_cands.run()
