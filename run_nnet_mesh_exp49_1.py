'''
    Exp 49_1
    Training set: 5K from MEDLINE 1960-2009
...
def main():
    ...
    nnet_outdir = 'exp.out/Exp_49_1;ndim={};batch={};max_norm={};learning_rate={};{}'.format(ndim, batch_size, max_norm, learning_rate, ts)
    ...
    print "Exp_49_1 MAP on test set: ", test_acc/100.0
    print    
