...
def main():
    ...
    # ndim = 100
    # max_emb_idx = numpy.max(a_train)
    # vocab_emb = numpy_rng.randn(max_emb_idx+1, ndim) # one additional row for 0
    # vocab_emb_overlap[-1] = 0 ## dummy word set to zero
    print "vocab_emb shape: ", vocab_emb.shape

    ndim = vocab_emb.shape[1]
    print "ndim: ", ndim
    dummpy_word_idx = numpy.max(a_train)
    print "dummy word index: ", dummpy_word_idx
